...
baseDir = '/Users/revanthvarma/Library/Mobile Documents/com~apple~CloudDocs/15663_CP/assgn6/data/checkerboard' #data directory
...
calName = 'selected' #calibration sourse (also a dir in data)
image_ext = 'png' #file extension for images
useLowRes = False #enable lowres for debugging

#Extrinsic calibration parameters
dW1 = (8, 8) #window size for finding checkerboard corners
checkerboard = (6, 9) #number of internal corners on checkerboard

#Intrinsic calibration parameters
# dX = 558.8 #calibration plane length in x direction
# dY = 303.2125 #calibration plane length in y direction
dX = 180 #calibration plane length in x direction
dY = 560 #calibration plane length in y direction
...
firstFrame = os.path.join("/Users/revanthvarma/Library/Mobile Documents/com~apple~CloudDocs/15663_CP/assgn6/data/ball/frame821.png")
